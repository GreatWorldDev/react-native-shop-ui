...
To contribute your changes to the main repository, create a pull request from your fork [here](https://github.com:GreatWorldDev/react-native-shop-ui.git) (click the `compare across forks` link make your repository the source repository)
